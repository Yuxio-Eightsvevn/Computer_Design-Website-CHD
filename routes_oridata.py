...
async def upload_oridata(username: str, files: List[UploadFile] = File(...)):
    ...
    try:
        ...
        if not contains_slash:
            # treat as single generated case name
        ...
        # else check if all have length == 2 -> treat as caseName/file
        ...
        # If here, mixed or unsupported structure
