import argparse
import yaml
config_path = 'D:/实验室/workTable/26_3_17_web/worktable/models/Codes/config/test_config_ResnetrTransformerDualToken_1107_18cls_layersdecouple44.yaml'
...
from Codes.main_codes.utils import *
import matplotlib.pyplot as plt
...
DATASET_ROOT_DIR = 'D:/实验室/workTable/26_3_17_web/worktable/models/input_path/request_test'
OUTPUT_DIR = 'D:/实验室/workTable/26_3_17_web/worktable/models/output_path/test_test_original'

# 获取所有case文件夹（直接遍历DATASET_ROOT_DIR下的所有子文件夹作为case）
FOLDERS_TO_PROCESS = [d for d in os.listdir(DATASET_ROOT_DIR) if os.path.isdir(os.path.join(DATASET_ROOT_DIR, d))]
print(f"将处理以下case: {FOLDERS_TO_PROCESS}")
...
def get_coarse_label_from_folder_name(folder_name):
    """从文件夹名获取标签（已不再使用，改为从文件名获取）"""
    return 0  # 默认返回0

def get_label_from_filename(filename):
    """从文件名中提取标签"""
    filename_lower = filename.lower()
    if '_label_pda' in filename_lower:
        return 3  # PDA
    elif '_label_asd' in filename_lower:
        return 2  # ASD
    elif '_label_vsd' in filename_lower:
        return 1  # VSD
    elif '_label_normal' in filename_lower:
        return 0  # Normal
    else:
        return 2  # 默认ASD
...
if __name__ == '__main__':
    ...
    MODEL_CONFIGS = {
        '4x4': {
            'resume_path': 'D:/实验室/workTable/26_3_17_web/worktable/models/singleview/spatial_size_4.pth',
            'baseline_path': 'D:/实验室/workTable/26_3_17_web/worktable/models/Baseline_4size/final_baseline_features_4x4_512dim_1101.pt',
            'spatial_resolution': 4
        },
        '5x5': {
            'resume_path': 'D:/实验室/workTable/26_3_17_web/worktable/models/singleview/spatial_size_5.pth',
            'baseline_path': 'D:/实验室/workTable/26_3_17_web/worktable/models/Baseline_4size/final_baseline_features_5x5_512dim_1101.pt',
            'spatial_resolution': 5
        },
        '6x6': {
            'resume_path': 'D:/实验室/workTable/26_3_17_web/worktable/models/singleview/spatial_size_6.pth',
            'baseline_path': 'D:/实验室/workTable/26_3_17_web/worktable/models/Baseline_4size/final_baseline_features_6x6_512dim_1101.pt',
            'spatial_resolution': 6
        },
        '7x7': {
            'resume_path': 'D:/实验室/workTable/26_3_17_web/worktable/models/singleview/spatial_size_7.pth',
            'baseline_path': 'D:/实验室/workTable/26_3_17_web/worktable/models/Baseline_4size/final_baseline_features_7x7_512dim_1101.pt',
    ...
    for folder_path_suffix in tqdm(FOLDERS_TO_PROCESS, desc="Pre-scanning Folders"):
        ...
        for item_name in os.listdir(source_folder_path):
            ...
            if video_path:
                ...
                cases_database[case_id]["label"] = label
